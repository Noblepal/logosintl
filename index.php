...
<body>
  ...
  <!-- hero slider -->
  <section class="hero-section overlay bg-cover" data-background="images/logos_intl/logos_01.jpg">
    <div class="container">
      <div class="hero-slider">
        ...
        <div class="hero-slider-item">
          <div class="row">
            <div class="col-md-8">
              <h1 class="text-white" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".1">Welcome All</h1>
              <p class="text-muted mb-4" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".4">Anyone can study with us from 18 years and above</p>
        ...
        <div class="hero-slider-item">
          <div class="row">
            <div class="col-md-8">
              <h1 class="text-white" data-animation-out="fadeOutUp" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".1">Be Empowered Today</h1>
              <p class="text-muted mb-4" data-animation-out="fadeOutUp" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".4">Registration ongoing</p>
        ...
        <div class="hero-slider-item">
          <div class="row">
            <div class="col-md-8">
              <h1 class="text-white" data-animation-out="fadeOutDown" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".1">Logos International Bible University</h1>
              <p class="text-muted mb-4" data-animation-out="fadeOutDown" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".4">With Dr. Anabel, Chancellor</p>
    ...
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        <div class="col-xl-4 col-lg-5 align-self-end">
          <img class="img-fluid w-100" src="images/logos_intl/logos_05.jpg" alt="banner-feature">
        </div>
        <div class="col-xl-8 col-lg-7">
          <div class="row feature-blocks bg-gray justify-content-between">
            <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
              ...
              <p>Join us today and get empowered.</p>
            </div>
            <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
            ...
            <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
              ...
              <p>December 14<sup>th</sup> Graduation Ceremony</p>
              <p>December 6<sup>th</sup> Graduation Ceremony</p>
            </div>
            <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 order-2 order-md-1">
          <h2 class="section-title">About Logos International</h2>
          <p>A Logos International Bible University (online) We follow the steps of the greatest teacher of all times who is Jesus Christ He Taught His disciple about the Kingdom of God.</p>
          <p>Join our Institution where you will be taught All about Apologetics, Hermeneutics, Homiletics and Much More. Distance Learning is provided at a very affordable cost.</p>
          <p>Email us <a href="mailto:logosintlbibleuniversity@gmail.com">logosintlbibleuniversity@gmail.com</a></p>
          <a href="#about.html" class="btn btn-primary-outline">Learn more</a>
        </div>
        <div class="col-md-6 order-1 order-md-2 mb-4 mb-md-0">
          <img class="img-fluid w-100" src="images/logos_intl/logosintl.png" alt="about image">
        </div>
      </div>
    </div>
  </section>
